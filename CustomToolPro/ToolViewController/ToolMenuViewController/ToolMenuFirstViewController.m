...
@interface ToolMenuFirstViewController ()<JKMenuViewDelegate>
...
@implementation ToolMenuFirstViewController
...
- (void)viewDidLoad {
    ...
    [pieChartBtn setCenter:self.view.center];
